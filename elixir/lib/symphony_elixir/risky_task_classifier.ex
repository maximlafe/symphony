defmodule SymphonyElixir.RiskyTaskClassifier do
  ...
  def classify(input) when is_map(input) do
    ...
    %{
      ...
      "delivery_class" => delivery_classification["delivery_class"],
      "delivery_sensitive" => delivery_classification["delivery_sensitive"],
  ...
  def classify(_input) do
    %{
      ...
      "delivery_classification" => DeliveryContract.classify(%{}),
      "cost_signals" => [],
      "reasons" => []
    }
  end
