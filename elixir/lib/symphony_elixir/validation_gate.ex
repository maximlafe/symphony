defmodule SymphonyElixir.ValidationGate do
  ...
  @check_aliases %{
    ...
    "targeted runtime contract tests" => "targeted_tests",
    "targeted_runtime_contract_tests" => "targeted_tests",
    "runtime/contract final gate" => "runtime_smoke",
    "runtime/contract_final_gate" => "runtime_smoke",
    "runtime contract final gate" => "runtime_smoke",
    "runtime_contract_final_gate" => "runtime_smoke",
