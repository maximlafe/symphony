defmodule SymphonyElixir.ExtensionsTest do
    ...
    assert state_payload == %{
             ...
             "running" => [
               %{
                 ...
                 "turn_id" => "turn-http",
                 "replacement_of_session_id" => "thread-http-prev",
                 "replacement_session_id" => "thread-http",
                 "turn_count" => 7,
             ...
             "retrying" => [
               %{
                 ...
                 "turn_id" => "turn-retry",
                 "replacement_of_session_id" => "thread-retry",
                 "replacement_session_id" => nil,
  ...
  test "dashboard bootstraps liveview from embedded static assets" do
    ...
    assert html =~ "var appendCanonicalLocale = function (target, value) {"
    assert html =~ "var buildDateTimeFormatter = function (options) {"
    assert html =~ "new window.Intl.DateTimeFormat(undefined, options);"
    ...
    refute html =~ "new window.Intl.DateTimeFormat(localResetLocale, {"
