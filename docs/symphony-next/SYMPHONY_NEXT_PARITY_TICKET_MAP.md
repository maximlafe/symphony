...
| `PARITY-05` | `done` | `parity/parity-05-encode-review-finalizer-semantics` | `https://github.com/maximlafe/symphony/pull/147` | `45c97dce969cd57ec5bf02469250dded2510c729` | Canonical finalizer semantics contract + deterministic/live fixtures + executable parity suite validated; CI green + merged; post-merge sanity passed (`make symphony-preflight`, `mix test test/symphony_elixir/finalizer_semantics_parity_test.exs`). Evidence: `docs/symphony-next/evidence/PARITY-05/PARITY-05_EVIDENCE_2026-04-26.md` |
| `PARITY-06` | `done` | `parity/parity-06-prove-merge-gating-parity` | `https://github.com/maximlafe/symphony/pull/148` | `16a0dbbf163b9ed79b87596abb5549c82cd22e26` | Merge-gating fail-closed allowlist (`CLEAN`/`HAS_HOOKS`) + deterministic/live/stale-proof parity contract validated; CI green + merged; post-merge sanity passed (`make symphony-preflight`, `mix test test/symphony_elixir/merge_gating_parity_test.exs`). Evidence: `docs/symphony-next/evidence/PARITY-06/PARITY-06_EVIDENCE_2026-04-26.md` |
| `PARITY-14` | `done` | `parity/parity-14-actionable-feedback-classification` | `https://github.com/maximlafe/symphony/pull/149` | `d57aea23eb66ad66b4cc5bf4e8fcb7d676f8ee14` | Explicit review-feedback classification (`review_state_summary`, `actionable_feedback_state`, item-level `classification`) wired to workflow guards (`ControllerFinalizer`, `HandoffCheck`) with backward-compatible bool fallback; deterministic/live fixtures + dedicated parity suite validated; CI green + merged; post-merge sanity passed (`make symphony-preflight`, `mix test test/symphony_elixir/actionable_feedback_parity_test.exs`). Evidence: `docs/symphony-next/evidence/PARITY-14/PARITY-14_EVIDENCE_2026-04-26.md` |
| `PARITY-07` | `done` | `parity/parity-07-long-lived-runtime-recovery` | `https://github.com/maximlafe/symphony/pull/150` | `05ab8ae51510b1c87c552c78d5897d5db870848a` | Runtime recovery parity contract + deterministic/live fixtures + dedicated parity suite validated; live fixture contains canonical resume classes and no replacement-scope `unknown`; CI green + merged; post-merge sanity passed (`make symphony-preflight`, `mix test test/symphony_elixir/runtime_recovery_parity_test.exs`). Evidence: `docs/symphony-next/evidence/PARITY-07/PARITY-07_EVIDENCE_2026-04-26.md` |
