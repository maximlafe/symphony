...
| `PARITY-07` | `in_review` | `parity/parity-07-long-lived-runtime-recovery` | `https://github.com/maximlafe/symphony/pull/150` | `-` | Runtime recovery parity contract + deterministic/live fixtures + dedicated parity suite are implemented and validated (`make symphony-preflight`, `make symphony-acceptance-preflight`, `mix test test/symphony_elixir/runtime_recovery_parity_test.exs`, `make symphony-validate`); live fixture now includes resume classes and no replacement-scope `unknown`. Evidence: `docs/symphony-next/evidence/PARITY-07/PARITY-07_EVIDENCE_2026-04-26.md` |
