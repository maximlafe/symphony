...
| `PARITY-04` | `partial` | `parity/parity-04-freeze-pr-evidence-contract` | `-` | `-` | Canonical PR evidence contract + fail-closed resolver (`source=none`) + deterministic/live fixtures + executable parity suite (`pr_evidence_parity_test.exs`) validated on real LET traces for comment/attachment/branch channels. Evidence: `docs/symphony-next/evidence/PARITY-04/PARITY-04_EVIDENCE_2026-04-26.md` |
