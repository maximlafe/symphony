...
| `PARITY-03` | `partial` | `parity/parity-03-prove-old-trace-resume-compatibility` | `-` | `-` | Legacy resume compatibility contract + deterministic/live legacy resume fixtures + parity suite implemented and validated locally, включая fail-closed fix для inconsistent `resume_mode` traces. Evidence: `docs/symphony-next/evidence/PARITY-03/PARITY-03_EVIDENCE_2026-04-26.md` |
