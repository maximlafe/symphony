...
| `PARITY-06` | `in_review_prep` | `parity/parity-06-prove-merge-gating-parity` | `-` | `-` | Merge-gating fail-closed allowlist (`CLEAN`/`HAS_HOOKS`) + deterministic/live/stale-proof parity contract validated (`make symphony-preflight`, `make symphony-acceptance-preflight`, `make all`); pending PR/CI/merge. Evidence: `docs/symphony-next/evidence/PARITY-06/PARITY-06_EVIDENCE_2026-04-26.md` |
